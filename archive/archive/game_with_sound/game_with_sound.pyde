...
class BlockList(list):
    ...
    def __init__(self):
        ...
        for r in range(10):
            for c in range(5):
                if r % 5 == 0 and c % 4 == 0:
                    self.append(BrickBlock(100 * c, 50 * r, 100, 50, 1))
...
class Background:
    ...
    def __init__(self):
        ...
        self.__backgroundImage = loadImage(PATH + "/Resources/Background/starryNight.jpg")

    def display(self):
        
        image(self.__backgroundImage, 0, 0, WIDTH, HEIGHT)
